...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-09-2022 a las 06:27:53
...
(2, 'Ana', 'Diaz', 'Mundaca', 'DNI', '48596879', 'Chiclayo - Ca. ', '98745698', ''),
(3, 'Tatiana', 'Gomez', 'Sadaña', 'DNI', '10234', 'cll49b sur', '334554565', 'tatsdw@dfdf'),
(7, 'Tatiana', 'Gomez', 'Sadaña', 'DNI', '10234', 'cll49b sur', '4545464', 'tatsdw@gmail.com');
...
CREATE TABLE `reserva` (
  ...
  `costo_alojamiento` decimal(12,2) NOT NULL,
  `estado` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(7, '345566777.00', 'Administrador', 'Ffreyja', '280687', 'A');
