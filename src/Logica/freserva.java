...
public class freserva {
    ...
    public DefaultTableModel mostrar(String buscar){
       ...
       sSQL="select r.idreserva,r.idhabitacion,h.numero,r.idcliente,"+
               "(select nombre from persona where idpersona=r.idcliente)as clienten,"+// para mostrar el nombre de ese cliente
               "(select apaterno from persona where idpersona=r.idcliente)as clienteap,"+ // para mostrar el apellido de ese cliente
               "r.idtrabajador,(select nombre from persona where idpersona=r.idtrabajador)as trabajadorn,"+ // para mostrar el nombre del trabajador
               "(select apaterno from persona where idpersona=r.idtrabajador)as trabajadorap,"+  // para mostrar el apellido del trabajador
